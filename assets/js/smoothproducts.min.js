    ...
    a.fn.extend({
        smoothproducts: function() {
                ...
                if (b > 1) {
                    ...
                    a("a", this).each(function(b) {
                        var f = a("img", this).attr("src")
                          , g = a(this).attr("href")
                          , h = "";
                        (0 === b && !e || a(this).hasClass("sp-default")) && (h = ' class="sp-current"',
                        c = g,
                        d = a("img", this)[0].src),
            ...
            a(document.body).on("click", ".sp-non-touch .sp-zoom", function(b) {
                ...
                d > 1 && (a(".sp-lightbox").append("<a href='#' id='sp-prev'></a><a href='#' id='sp-next'></a>"),
                1 == e ? a("#sp-prev").css("opacity", ".1") : e == d && a("#sp-next").css("opacity", ".1")),
